...
#define MyAppName "Amazon Polly TTS for Windows (64-bit)"
...
[Icons]
Name: "{group}\Polly Player (64-bit)"; Filename: "{app}\PollyPlayer.exe"; WorkingDir: "{app}"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Run]
Filename: "{tmp}\vc_redist.x64.exe"; Parameters: "/install /passive /norestart"; StatusMsg: Installing Visual Studio Runtime Libraries...; Flags: 64bit; Check: IsWin64
...
[UninstallRun]
Filename: "{app}\InstallVoices.exe"; Parameters: "uninstall"; Flags: 64bit;
Filename: "{sys}\Regsvr32.exe"; Parameters: "/s /u pollyttswindows.dll"; WorkingDir: "{app}"; StatusMsg: "Unregistering Polly TTS Engine ... "; Flags: runhidden 64bit;
